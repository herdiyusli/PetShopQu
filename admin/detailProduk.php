...
<div class=" detail-produk p-3 mt-3 bg-primary text-light ">
    ...
    <div id="ubah-data">
        <div class="card w-100 text-dark ">
            <div class="card-body border-top">
                <h5 class="card-title text-uppercase">Edit Data Produk</h5>
            </div>
            <form class="ml-3" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group mx-2 col-sm-5 ">
                        ...
                        <select class="form-control " name="kategori" id="">
                            <?php if ($produk['produk']->kategori == "Makanan") : ?>
                                <option selected value="Makanan">Makanan</option>
                                <option value="Aksesoris">Aksesoris</option>
                            <?php else : ?>
                                <option value="Makanan">Makanan</option>
                                <option selected value="Aksesoris">Aksesoris</option>
                            <?php endif; ?>
                        </select>
                    </div>
                    <div class="form-group mx-2 col-sm-5 ">
                ...
                <div class="row mb-3">
                    <div class="form-group mx-2 col-sm-3 ">
                        ...
                        <img src="<?= url . 'assets/images/produk/' . $produk['produk']->gambar ?>" style="width: 80px" alt=""></br></br>
